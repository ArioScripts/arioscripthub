    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          That script or page isn't here anymore.
        </p>
        <div className="mt-6">
          <Link
            to="/"
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ARIO SCRIPTS — Game Script Database" },
      {
        name: "description",
        content: "Browse, copy and download working game scripts with previews and showcases.",
      },
      { property: "og:site_name", content: "ARIO SCRIPTS" },
